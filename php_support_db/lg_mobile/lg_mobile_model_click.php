...
if(isset( $_POST["changed_model_name"] , $_POST["date"]  )){
		...
		$query = "SELECT DISTINCT model_name FROM lg_db WHERE support_date ='".$_POST["date"]."'";
		...
		$query = "SELECT * FROM lg_db WHERE model_name ='".$_POST["changed_model_name"]."' AND support_date = '".$_POST["date"]."'  ORDER BY machine_name , model_name , plan_money";
        $sql = mysqli_query($conn, $query);
