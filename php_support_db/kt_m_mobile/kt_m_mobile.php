...
<center>
    <div class="flexbox2 wrapper">
        ...
        <span> KT_M_Mobile / 공시지원금 변동현황</span>
...
<center id="purchase_order">
    ...
    <?php
    $query = "SELECT DISTINCT machine_name FROM kt_m_mobile WHERE support_date='$today'";
    ...
    while ($row = mysqli_fetch_array($sql)) {
        ...
        if ($t % 5 == 0) {
            ?>
            <button type="button" id="change_name"
                    class="btn btn-outline-info"><?php echo $row['machine_name']; ?></button>
            <br>
            <?php
        } else {
            ?>
    ...
    <div class="container">
        <div class="table-responsive">
            <table>
                ...
                <?php
                $query = "SELECT * FROM kt_m_mobile WHERE support_date='$today' ORDER BY machine_name , plan_money";
                $sql = mysqli_query($conn, $query);
