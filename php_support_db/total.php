...
$today_data_list = array($today_skt_world, $today_kt_shop, $today_u_plus_shop, $today_lg_db, $today_sk7_db, $today_kt_m_mobile, $today_today_hello_kt, $today_today_hello_skt);
$data_list = array('skt_world', 'kt_shop', 'u_plus_shop', 'lg_db', 'sk7_db', 'kt_m_mobile', 'hello_mobile_kt', 'hello_mobile_skt');
...
<center id="purchase_order">
    ...
    <div class="flexbox wrapper center">
        ...
        if ($today_data_list[0] > 0) {
            ?>
            <button id="move_skt_world" class="btn btn-outline-danger button_size">
                SKT<?php echo "</br> $today_data_list[0]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_skt_world" class="btn btn-outline-info button_size">
                SKT<?php echo "</br> $today_data_list[0]" ?>건
            </button>
            <?php
        }
        ...
        if ($today_data_list[1] > 0) {
            ?>
            <button id="move_kt_shop" class="btn btn-outline-danger button_size">
                KT<?php echo "</br> $today_data_list[1]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_kt_shop" class="btn btn-outline-info button_size">
                KT<?php echo "</br>$today_data_list[1]" ?>건
            </button>
            <?php
        }
        ...
        if ($today_data_list[2] > 0) {
            ?>
            <button id="move_lg_u_plus" class="btn btn-outline-danger button_size">LG
                U+<?php echo "</br> $today_data_list[2]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_lg_u_plus" class="btn btn-outline-info button_size">LG
                U+<?php echo "</br>$today_data_list[2]" ?>건
            </button>
            <?php
        }
    ...
    <div class="flexbox wrapper center">
        ...
        if ($today_data_list[3] > 0) {
            ?>
            <button id="move_lg_mobile" class="btn btn-outline-danger button_size">
                U+알뜰모바일<?php echo "</br> $today_data_list[3]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_lg_mobile" class="btn btn-outline-info button_size">
                U+알뜰모바일<?php echo "</br>$today_data_list[3]" ?>건
            </button>
            <?php
        }
        ...
        if ($today_data_list[4] > 0) {
            ?>
            <button id="move_sk7" class="btn btn-outline-danger button_size">SK
                7모바일<?php echo "</br> $today_data_list[4]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_sk7" class="btn btn-outline-info button_size">SK
                7모바일<?php echo "</br>$today_data_list[4]" ?>건
            </button>
            <?php
        }
        ...
        if ($today_data_list[5] > 0) {
            ?>
            <button id="move_kt_m_mobile" class="btn btn-outline-danger button_size">KT
                M모바일<?php echo "</br> $today_data_list[5]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_kt_m_mobile" class="btn btn-outline-info button_size">KT
                M모바일<?php echo "</br>$today_data_list[5]" ?>건
            </button>
            <?php
        }
        ...
        if ($today_data_list[6] > 0) {
            ?>
            <button id="move_hello_mobile_skt" class="btn btn-outline-danger button_size">
                헬로모바일(SKT)<?php echo "</br> $today_data_list[6]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_hello_mobile_skt" class="btn btn-outline-info button_size">
                헬로모바일(SKT)<?php echo "</br>$today_data_list[6]" ?>건
            </button>
            <?php
        }
        ...
        if ($today_data_list[7] > 0) {
            ?>
            <button id="move_hello_mobile_kt" class="btn btn-outline-danger button_size">
                헬로모바일(KT)<?php echo "</br> $today_data_list[7]" ?>건
            </button>
            <?php
        } else {
            ?>
            <button id="move_hello_mobile_kt" class="btn btn-outline-info button_size">
                헬로모바일(KT)<?php echo "</br>$today_data_list[7]" ?>건
            </button>
            <?php
        }
