...
<div class="flexbox wrapper center">
    ...
    <button type="submit" id="kt_shop" class="button">KT</button>
...
<center id="purchase_order">
    ...
    <?php
    $query = "SELECT DISTINCT machine_name FROM kt_shop WHERE support_date='$today'";
    ...
    <div class="container">
        <div class="table-responsive">
            <table>
                ...
                <?php
                $query = "SELECT * FROM kt_shop WHERE support_date='$today' ORDER BY machine_name , model_name , plan_money";
                $sql = mysqli_query($conn, $query);
