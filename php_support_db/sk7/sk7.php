...
<div class="flexbox wrapper">
    ...
    <button type="submit" id="sk7" class="button">SK 7모바일</button>
    ...
    while ($row = mysqli_fetch_array($sql)) {
        ...
        if ($t % 5 == 0) {
            ...
            <button type="button" id="change_name"
                    class="btn btn-outline-info"><?php echo $row['model_name']; ?></button>
            <br>
            <?php
        } else {
            ?>
    ...
    <div class="container">
        <div class="table-responsive">
            <table>
                ...
                <?php
                $query = "SELECT * FROM sk7_db WHERE support_date='$today' ORDER BY machine_name , model_name , plan_money";
                $sql = mysqli_query($conn, $query);
