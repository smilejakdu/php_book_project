...
if(isset( $_POST["changed_model_name"] , $_POST["date"]  )){
		...
		$query = "SELECT DISTINCT model_name FROM hello_mobile_kt WHERE support_date ='".$_POST["date"]."'";
		...
		$query = "SELECT * FROM hello_mobile_kt WHERE model_name ='".$_POST["changed_model_name"]."' AND support_date = '".$_POST["date"]."'  ORDER BY machine_name , model_name , plan_money";
        $sql = mysqli_query($conn, $query);
