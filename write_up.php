...
<form enctype='multipart/form-data' action='./board/write_upload.php' method='post' id="board_form">
    ...
    <div class="container" style="padding-top:1em;">
        <div class="card" style="margin-bottom: 10px;">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="content" name="content" style="height: 530px;"
                              rows="3"> <?= $text['content'] ?></textarea>
                </div>
                <!-- 게시글 작성 폼 끝 -->

                <div id="ajaxImageModal" style="display:none;">
                    <div id="light"
                         style="display: table;position: absolute;top:25%;left:25%;width:50%;height:50%; text-align:center; background-color:transparent; z-index:1002;overflow: auto;">
                        <div style="display: table-cell; vertical-align: middle;">
                            <img src="/ckeditor/plugins/ajaximage/loading.gif"
                                 style="user-select: none; -ms-user-select: none;">
                        </div>
                    </div>
                </div>
        ...
        <div class="text-right" style="padding-bottom: 100px;">
            <button type="button" class="btn btn-primary" style="border-radius : 0.5em;" onclick="formset();">등록
            </button>
        </div>
