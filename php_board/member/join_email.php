...
//[메일 제목]//
$email_title = $name . "님" . $c_o['site_name'] . " 가입안내.";  //메일 제목
...
$email_content .= "<table border='0'  width='80%' height='120' align='center' bgcolor='#FFFFFF'>
                 ...
                 <img src='http://$_SERVER[HTTP_HOST]/image/xeronote.jpg'>
                 </td>";
$email_content .= "<tr>
              <td width='100%' align='center' class='box_1'>
              <strong>$name</strong>' 님 <b>" . $c_o['site_name'] . "</b>의 회원가입을 축하 드립니다.<br>
              <strong>$name</strong>'님의 <u>회원 아이디는'<strong>$user_id</strong></u>'입니다.
              </td>";
