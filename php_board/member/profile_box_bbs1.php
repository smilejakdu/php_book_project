        ...
        <tr>
            ...
            <td width='190' height='25' align='left' valign='middle'>
                <font color='FFFFFF'>
                    &nbsp;
                    <? if ($member['name']) {
//                        echo mb_strimwidth((string)$member['name'], 0, 10, "..", "UTF-8");
                    } else {
                        echo mb_strimwidth((string)$member['nickname'], 0, 10, "..", "UTF-8");
                    } ?>
                </font>
   ...
   L.<?= $member['level'] ?></span>
                ...
                <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/member/my_message.php" OnFocus="this.blur()">
                    <? if ($m_temp[0] >= 1) {
                        ?>
