...
<?
$terms = $_GET['terms'] ?? null;  //이용약간  & 개인정보취급 방침


if (!$terms and $ctg == "members") {  //회원가입페이지에서 보기!!
    ?>
    <table border='0' width='1280' height='120' bgcolor='FFFFFF' align='center' cellspacing='0' cellpadding='0'>
        <tr>
            <td width='95%' height='30' bgcolor='#FFFFFF' align='center'>&nbsp;</td>

        <tr>
            <td width='95%' height='20' bgcolor='#FFFFFF' align='center'>

                <h3><strong>개인정보 취급방침</strong></h3>
                <div class="privercy-contract-tap">
                    <ul id="new_privercy_tap">
                        <a href="#none" onClick="privercy_tap(0);" class="sel"><font color="#666666">수집하는 개인정보 항목</font></a>
                        &nbsp; &nbsp;
                        <a href="#none" onClick="privercy_tap(1);"><font color="#666666">개인정보의 수집 이용목적</font></a>
                        &nbsp; &nbsp;
                        <a href="#none" onClick="privercy_tap(2);" class="end"><font color="#666666">개인정보의 보유 및
                                이용기간</font></a>
                    </ul>
                </div>
            </td>
        ...
        <tr>
            <td width='95%' height='100' bgcolor='#FFFFFF' align='center'>
                <div class="tab-content" id="new_privercy_content">
                    <div class="privercy-contract">
		<textarea cols="70" style="width:1000px; height:110px; overlow-x:scroll;" readonly>
              [수집하는 개인정보 항목]
...
- 선택항목 : 개인맞춤 서비스를 제공하기 위하여 회사가 필요로 하는 정보
		...
		<textarea style="width:1000px; height:110px; overlow-x:scroll;" readonly>
              [개인정보의 수집 및 이용목적]
...
이벤트 등 광고성 정보 전달, 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
		...
		<textarea style="width:1000px; height:110px; overlow-x:scroll;" readonly>
           [개인정보의 보유 및 이용기간]
<?= $cinfo['site_name']; ?>은(는) 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이
...
<? } else if ($terms == "privacy_policy") {   //개인정보취급방침 페이지에서 보기!!?>
    <font class='ft_b1'>개인정보 취급방침</font>
    <p>&nbsp;</p><br>
    <font class='ft_b2'> [수집하는 개인정보 항목] </font>
    <br><br>
    <font class='ft_b3'>
    ...
    <br><br><br>
    <font class='ft_b2'>[개인정보의 수집 및 이용목적]</font>
    <br><br>
    <font class='ft_b3'>
    ...
    <br><br><br>
    <font class='ft_b2'>[개인정보의 보유 및 이용기간]</font>
    <br><br>
    <font class='ft_b3'>
