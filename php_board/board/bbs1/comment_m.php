<!---/////////////////////////////[코 멘 트 모바일/테블릿 PC버전]//////////////////////////////////--->
<table border='0px'   width='98%' cellspacing='0' cellpadding='0'>
<tr>
<?
////////////////////////  코멘트 NO 생성 /////////////////////////
$times=time();
...
?>
<td width='90%' align='center' bgcolor='FFFFFF'><hr></td>

<tr>
 <td  align='right' bgcolor='FFFFFF'>
   <span style="color: #9C9A9A; ">comment: <?=$total_count ?></span> &nbsp; &nbsp;
 </td>
...
<!--- 짧은 답글 출력 부분-------------->
<table  border='0'  width='98%' cellspacing='0' cellpadding='0' bgcolor='EDEDED'>
<?
$q = "select * from bbs1_comments where b_ID='".$data['b_ID']."' and !r_replys_no  order by  regdate asc , regdate_time asc ";
...
<td width='10' valign='middle' rowspan='3'>&nbsp;</td>
...
<? if($member['user_id']){?>
 <a href='view.php?r_replys_w=yes&b_ID=<?=$data['b_ID']?>&d_no=<?=$d['no']?>#lo_reply' onfocus="this.blur()">
 <span style='font-size:9pt; font-family:Tahoma; color:#2F84A3'>답글</span></a>
 <?}?>
  </td>
...
<tr>
<td valign='top'>
<span style='font-size:9pt; color:#8A8A88'><?=nl2br($d['memo']);?></span>
	</td>	
		
		<td align='center'>
		<? if($member['user_id']==$d['user_id']){?>
		<a href="comment_del.php?d_no=<?=$d['no']?>&no_s=<?=$data['b_ID']?>&b_ID=<?=$d['b_ID']?>&replys_all=all" onfocus="this.blur()" onclick="return confirm('정말로 삭제 하겠습니까?');">
		<span style='font-size:9pt; font-family:Tahoma; color:#CC558A'>삭제</span></a>
<?}?>
</td>
...
<table border='0' width='100%' height='5' valign='middle' bgcolor='FFFFFF'>
<tr>
<td width='10'>&nbsp;</td> 
...
while($d_ss_2 = mysqli_fetch_array($r_ss_2)){
...
<td width='10%' align='center'>
      <? if($member['user_id']==$d_2['user_id']){?>
		<a href="comment_del.php?d_no=<?=$d_2['no']?>&no_s=<?=$data['b_ID']?>&b_ID=<?=$d_2['b_ID']?>&r_replys_no=<?=$d_2['r_replys_no']?>&reply_rr=rr" onfocus="this.blur()" onclick="return confirm('정말로 삭제 하겠습니까?');">
		<span style='font-size:9pt; color:#D97E7E'>[del]</span></a>
		<?}else{ echo "&nbsp;"; } ?>
</td>
...
<td id='lo_reply' colspan='2' align='right'><font color='8A8A88'>→</font></td>
...
<tr>
<td  width='100%' height='15' align='center' valign='middle' colspan='4' bgcolor='FFFFFF' >
<hr size='0.1' width='95%' color='#E6E6E6' />
</td>
<?}?>
</tr>
 </table>
...
<!---------------  짧은 달글 입력 부분------------->
 ...
 <tr>
<td width='100%' height='20' colspan='5' align='center' valign='middle' bgcolor='#FFFFFF'>
댓 글 입 력
</td>
...
<input type=hidden name='nickname' value='<?=$member[nickname]?>'>
<input type=hidden name='r_replys_w' value='yes'>
<td width='20%' align='center' valign='middle' bgcolor='#E7CADE'>
<? if($member['nickname']){
...
<td width='5%' align='left' bgcolor='#FFD2F1'>&nbsp;</td>


	   <td width='65%' align='left' bgcolor='#FFD2F1'>
 <textarea name='memo' style="width:90%;"></textarea>
	   </td>
	   
	   
	   <td width='10%' align='center'> <input type=submit value='O K'></td>
	   </tr> 
     </table>
<?}?>
</form>
