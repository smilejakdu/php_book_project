					...
					<div class="card-body">
						...
						<div class="input-group" style="height: 43.5px;">
							<div class="form-group mx-sm-3">
								<select class="custom-select" id="searchColumn" name="searchColumn" style="height: 43.5px;">
									<option value="1" <?php if($searchColumn == "1"){echo "selected";}?>>제목</option>
									<option value="2" <?php if($searchColumn == "2"){echo "selected";}?>>내용</option>
									<option value="3" <?php if($searchColumn == "3"){echo "selected";}?>>작성자</option>
								</select>
							</div>
								
							<input type="text" class="form-control" style="height: 43px;"  id="searchText" name="searchText" placeholder="통합 검색" aria-label="Search" value="<?=$searchText?>">
							<span class="input-group-btn">
							<input type="submit" class="btn btn-warning" style="border-radius : 0.5em; height: 43px; width:85px; margin-left: 10px;" value="검색">
