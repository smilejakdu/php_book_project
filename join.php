...
<div class="container">
	...
	<form class="form-signin" action="./login/login_wh.php" method="post" enctype="multipart/form-data">
		<h2 class="form-signin-heading">JOIN</h2>
		<label for="userid" class="sr-only">ID</label>
		ID<input type="text" name="userid" id="userid" class="form-control" required="required" placeholder="아이디" autofocus>
		<label for="password" class="sr-only">Password</label>
		PW<input type="password" id="password" name="password" class="form-control" placeholder="Password" required>
		<div class="checkbox">
